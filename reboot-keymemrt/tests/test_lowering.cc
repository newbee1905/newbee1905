...
void run_case(const std::string &title, const model_config_t &config,
			  int num_slots) {
	fmt::print("{}\n", title);
	...
	std::mt19937 rng(17);
	tensor_inputs_t dense_inputs;
	slot_inputs_t slot_inputs;
